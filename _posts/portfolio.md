...
details:
  [
    { name: "Tech Stack", items: ["Astro", "TailwindCSS"] },
    {
      name: "App Features",
      items:
        [
...
summary: "As the IT-Director of UNSW's Mechatronics Society (Woo Fancy), I was tasked with creating a website to promote a Sumobot Tournament 🤖 For this, I created a simple statically generated website using Astro. You cand find it here
"
# <!-- ---
# **Lorem** 
